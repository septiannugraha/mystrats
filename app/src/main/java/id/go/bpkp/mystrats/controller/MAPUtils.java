...
public class MAPUtils {
    ...
    /** Pendlakarasian Shared MAPUtils yang berdasarkan paramater context */
    public static SharedPreferences getSharedPreference(Context context){
        return PreferenceManager.getDefaultSharedPreferences(context);
    }

    /** Deklarasi Edit MAPUtils dan mengubah data
    ...
    /** Deklarasi Edit MAPUtils dan menghapus data, sehingga menjadikannya bernilai default
